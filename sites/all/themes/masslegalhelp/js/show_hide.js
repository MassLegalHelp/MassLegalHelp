var show_text_status = "Show";

function toggleDiv(elemId) { 
var j = document.getElementsByTagName("sup").length;

if (document.getElementById(elemId)){
obj = document.getElementById(elemId);
if ( obj.style.display != "none" ) {
	obj.style.display = "none";
	for ( i=0; i<document.getElementsByTagName("sup").length; i++ ) {
		document.getElementsByTagName("sup")[i].style.display="none";
		document.getElementById("text_status_hide").style.display="none";
	} // for
	if ( j > 0) {
		document.getElementById("text_status_show").style.display="inline";
	} else {
		document.getElementById("text_status_show").style.display="none";
	} // if j
} else {
	...
	if (i > 0) {
		document.getElementById("text_status_hide").style.display="inline";
	} else {
		document.getElementById("text_status_hide").style.display="none";
	} // if i
} // if doc get elem 
